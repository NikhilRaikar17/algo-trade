...
def render_homepage():
    ...
    <div class="hp-root">
      ...
      <nav class="hp-nav">
        ...
        <a href="/app" class="hp-nav-btn">⚡ Launch App</a>
      </nav>
      ...
      <section class="hp-hero">
        ...
        <div class="hp-cta-row">
          <a href="/app" class="hp-btn-primary">🚀 Open Dashboard</a>
      ...
      <div class="hp-cta-bottom">
        ...
        <a href="/app" class="hp-btn-primary" style="font-size:1.05rem; padding:16px 40px;">
